...
git clone -b master --single-branch https://github.com/kenzok8/openwrt-packages/tree/master/luci-theme-edge package/new/luci-theme-edge
...
git clone -b master --single-branch https://github.com/kenzok8/openwrt-packages/tree/master/luci-theme-opentomato package/new/luci-theme-opentomato
...
git clone -b master --single-branch https://github.com/kenzok8/openwrt-packages/tree/master/luci-theme-argon_new package/new/luci-theme-argon_new
git clone -b master --single-branch https://github.com/kenzok8/openwrt-packages/tree/master/luci-theme-opentomcat package/new/luci-theme-opentomcat
