...
var proxywifi = ["NTJGJT-AC88U","NTJGJT-AC5300"];
for (var i = 0; i < proxywifi.length; i++) {
	if (wifiname==proxywifi[i]){
		$surge.setOutboundMode("direct");
		
		//setTimeout(function(){$notification.post("提醒:","您目前处于WIFI: "+wifiname,"Surge已变为直连模式");}, 3000);
		break;
	...
	if (i==proxywifi.length-1){
		...
		//setTimeout(function(){$notification.post("提醒:","Surge已变为规则模式","");}, 3000);
